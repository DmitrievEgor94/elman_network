...
class ElmanRegression:
    ...
    def forward(self, x):
        ...
        self.layers[1][...] = sigmoid(np.dot(self.layers[0], self.weights[0]))
        self.layers[2][...] = np.dot(self.layers[1], self.weights[1])
    ...
    def backward(self, target, lrate=0.1, momentum=0.1):
        ...
        # подсчет ошибок на выходном слое (используется производная 1/2 * MSE)
...
if __name__ == '__main__':
    network = ElmanClassification(4, 3, 4)
